...
<div class="header">
	<label>PT MITRA UTAMA ENERGI - DAFTAR SOPIR</label>
</div>
<div class="contain">
	<div class="nav">
		<a href="../../home.php">
	...
	<div class="main">
		<div class="menu">
			<a href="form.php">
				<div class="menu-item">Tambah Sopir</div>
			</a>
			<div class="search">
				<form action="#" method="GET">
					<input type="text" name="search" placeholder="Cari Sopir" id="cari" style="border: 3px inset rgba(0,0,0,.4);">
				</form>
			</div>
		</div>
		<div class="lain">
				...
				<table width="100%">
					<?php 
						...
						if ($null == 0) {
							?>
								<tr align="center">
									<td rowspan="4" colspan="4"><h2>Belum ada data yang dibuat</h2></td>
								</tr>
							<?php
						}
						while ($data = mysqli_fetch_assoc($query)) { 
							...
							?>
								<tr>
									...
									<td width="216" align="center"><a href="form.php?update=1&id=<?php echo($data['id_driver'])?>">Ubah</a> || <a href="del.php?id=<?php echo($data['id_driver']) ?>" onclick = "return confirm('Ingin menghapus data?')" style="background-color: red;">Hapus</a></td>
								</tr>
					<?php	$no++;
						}
					?>
