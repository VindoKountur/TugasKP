...
<div class="contain">
	...
	<div class="main">
		<form action="buat.php" method="GET">
			<div class="head">
				<label>Tambah Truk</label>
			</div>
			<?php if (isset($_GET['update'])) {
				$id = $_GET['id'];
				$query = mysqli_query($db,"SELECT * FROM truk WHERE id_truk = '$id'");
				$data = mysqli_fetch_assoc($query);
				echo "<input type='hidden' name='update' value='1'>";
				echo "<input type='hidden' name='id' value='$id'>";
			} ?>
			<div class="row m5">
				<div class="col-25"><label>Nomor Plat<label></div>
				<div class="col-75">
					: <input type="text" name="nomorplat" required <?php if (isset($_GET['update'])) { echo "value='$data[nomor_plat]'"; } ?>>
				</div>
			</div>
			<div class="row">
