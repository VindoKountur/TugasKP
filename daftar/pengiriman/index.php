...
<div class="header">
	<label>PT MITRA UTAMA ENERGI - DAFTAR LOKASI PENGIRIMAN</label>
</div>
<div class="contain">
	<div class="nav">
		<a href="../../home.php">
	...
	<div class="main">
		<div class="menu">
			<a href="form.php">
				<div class="menu-item">Tambah Lokasi</div>
			</a>
			<div class="search">
				<form action="#" method="GET">
					<input type="text" name="search" placeholder="Cari Lokasi" id="cari" style="border: 3px inset rgba(0,0,0,.4);">
				</form>
			</div>
		</div>
		<div class="lain">
